...
<br><br>
<input type="button" value="Chrono" onclick="chrono()"> <br>
<input type="button" value="RaZ" onclick="rasee()"> <br>
<input type="button" value="Tempo" onclick="clearTimeout(compte)"> <br>
</form>
    </body>
</html>
