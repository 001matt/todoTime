            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="text-center" name="chronoForm">
                        <button class="btn btn-info" type="button" name="startstop" value="start!"
                                onClick="chronoStart()"><i class="fa fa-play"></i></button>
                        <button class="btn btn-info" type="button" name="reset" value="reset!" onClick="chronoReset()">
